...
func (r *EmberStorageBackendReconciler) csiDriverForEmberStorageBackend(ecsi *embercsiv1alpha1.EmberStorageBackend) *storagev1beta1.CSIDriver {
	trueVar := true
...
func (r *EmberStorageBackendReconciler) statefulSetForEmberStorageBackend(ecsi *embercsiv1alpha1.EmberStorageBackend) *appsv1.StatefulSet {
